...
include '../koneksi.php';
  $id = $_GET['kode'];
  $sql = "SELECT * FROM t_fungsional WHERE Kd_fungsional='$id'";
  $query = $db->query($sql);
      ...
      <!-- form tambah Tunjangan Struktural -->
          ...
          <?php
            if(isset($_POST["tambah"])) {
              ...
              $sql="UPDATE t_fungsional SET Jumlah='$jumlah' WHERE Kd_fungsional='$id'";
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="center-align">
                    <h5>Ubah Data Tunjangan fungsional </h5>    
                  </div>
                </div>
                ...
                <div class="row center">
                  <div class="input-field col s6 offset-s3">
                    <input name="kode" value="'.$data['Kd_fungsional'].'" id="Kd_fungsional" type="text" class="validate">
                ...
                <div class="row">
                  <div class="input-field col s6 offset-s3">
                    <input name="jumlah" value="'.$data['Jumlah'].'" id="t_fungsional" type="text" class="validate">
                    <label for="t_fungsional">Jumlah Tunjangan Fungsional  </label>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="input-field center-align">
                    <a href="t_fungsional.php" class="btn waves-effect waves-light blue center">Kembali</a>
