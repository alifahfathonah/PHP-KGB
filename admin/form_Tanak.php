        ...
        <div id="modal1" class="modal">
          ...
          <?php
            if(isset($_POST["tambah"])) {
              ...
              $sql="INSERT INTO t_anak VALUES('$id',$anak','$jumlah')";
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="center-align">
                    <h5>Input Data Tunjangan Anak </h5>    
                  </div>
                </div>
                ...
                <div class="row center">
                  <div class="input-field">
                    <input name="kode" required placeholder="Masukkan kode Tunjangan anak " id="Kd_anak" type="text" class="validate">
                ...
                <div class="row">
                  <div class="input-field">
                    <input name="jumlahanak" required placeholder="Masukkan Jumlah Anak" id="jumlahanak" type="text" class="validate">
                ...
                <div class="row">
                  <div class="input-field">
                    <input name="jumlah" required placeholder="Masukkan Jumlah Tunjangan Anak" id="tunjangananak" type="text" class="validate">
                    <label for="tunjangananak">Jumlah Tunjangan Anak  </label>
                  </div>
                </div>
    ...
    <!-- Tampil data -->
      <div class="row">
          <div class="col s10 offset-s1">
            <h5 class="center-align">Tunjangan Anak</h5>
            <table class="bordered highlight responsive-table">
              ...
              <tbody>
                ...
                <?php
                $sql = "SELECT * FROM t_anak";
                $query = $db->query($sql);
                $no =1;
                while ($row = $query->fetch_array()){;?>
                    <tr>
                      <td><?php echo $no++;?></td>
                      <td><?php echo $row["Kd_Tanak"]; ?></td>
                      <td><?php echo $row["jumlah"]; ?></td>
                      <td>Rp <?php echo number_format($row["Tanak"],0,",","."); ?>,-</td>
                      <td>
                        <?php echo' <a href="editTanak.php?kode='.$row['Kd_Tanak'].'" class="waves-effect waves-light btn">Edit Data </a>';?>
                        <?php echo' <a href="delTanak.php?kode='.$row['Kd_Tanak'].'" class="waves-effect waves-light red btn">Hapus Data </a>';?>
                      </td>
