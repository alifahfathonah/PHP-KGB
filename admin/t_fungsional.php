        ...
        <div id="modal1" class="modal">
          ...
          <?php
            if(isset($_POST["tambah"])) {
              ...
              $sql="INSERT INTO t_fungsional VALUES('$id','$jumlah')";
              $hasil=mysqli_query($db,$sql);

              if($hasil) {
                echo"<script>window.alert('DATA BERHASIL DISIMPAN');;window.location='../admin/t_fungsional.php'</script>";
              } 
                else {
                  echo $db->error;
                }     
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="center-align">
                    <h5>Input Data Tunjangan Fungsional </h5>    
                  </div>
                </div>
                ...
                <div class="row center">
                  <div class="input-field">
                    <input name="kode" required placeholder="Masukkan kode Tunjangan Fungsional " id="Kd_fungsional" type="text" class="validate">
                    <label for="Kd_fungsional">Kode Tunjangan </label>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="input-field">
                    <input name="jumlah" required placeholder="Masukkan Jumlah Tunjangan Fungsional" id="Tstruktural" type="text" class="validate">
                    <label for="Tstruktural">Jumlah t_fungsional  </label>
                  </div>
                </div>
    ...
    <!-- Tampil data -->
      <div class="row">
          <div class="col s10 offset-s1">
            <h5 class="center-align">Tunjangan Fungsional</h5>
            <table class="bordered highlight responsive-table">
              ...
              <tbody>
                ...
                <?php
                $sql = "SELECT * FROM t_fungsional";
                $query = $db->query($sql);
                $no =1;
                while ($row = $query->fetch_array()){;?>
                    <tr>
                      <td><?php echo $no++;?></td>
                      <td><?php echo $row["Kd_fungsional"]; ?></td>
                      <td><?php echo $row["Jumlah"];?> %</td>
                      <td>
                        <?php echo' <a href="editfungsional.php?kode='.$row['Kd_fungsional'].'" class="waves-effect waves-light btn">Edit Data </a>';?>
                        <?php echo' <a href="delfungsional.php?kode='.$row['Kd_fungsional'].'" class="waves-effect waves-light red btn">Hapus Data </a>';?>
                      </td>
