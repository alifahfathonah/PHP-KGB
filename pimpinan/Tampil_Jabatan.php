  ...
  <nav>
      <div class="nav-wrapper  deep-purple darken-2">
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li class="active"><a href="Tampil_Jabatan.php">Jabatan</a></li>
...
<!-- MENU -->
    ...
    <div class="row white">
      <div class="col s10 offset-s1">
        <h5 class="center-align">Jabatan</h5>
        ...
        <!-- Paging -->  
          <ul class="pagination">
            <?php if( $halamanaktif > 1) : ?>
              <li class="waves-effect"><a href="Tampil_Jabatan.php?halaman=<?php echo $halamanaktif - 1; ?>"><i class="material-icons">skip_previous</i></a></li>
            <?php endif; ?>

            <?php for( $i = 1; $i <= $jumhalaman; $i++) : ?>
                <?php if( $i == $halamanaktif) : ?>
                  <li class="active"><a href="Tampil_Jabatan.php?halaman=<?php echo $i ?>"><?php echo $i; ?></a></li>
                <?php else : ?>
                  <li class="waves-effect"><a href="Tampil_Jabatan.php?halaman=<?php echo $i ?>"><?php echo $i; ?></a></li>
                <?php endif; ?>
            <?php endfor; ?>

            <?php if( $halamanaktif < $jumhalaman) : ?>
              <li class="waves-effect"><a href="Tampil_Jabatan.php?halaman=<?php echo $halamanaktif + 1; ?>"><i class="material-icons">skip_next</i></a></li>
            <?php endif; ?>
          </ul>
        <!-- Paging -->
        </div>
