...
<body background="../Gambar/Hijau.jpg">
 ...
 <!-- Dropdown Structure 1 -->
    <ul id="dropdown1" class="dropdown-content">
      ...
      <li class="active"><a href="Tampil_Tjarak.php">Tunjangan Transportasi </a></li>
...
<!-- MENU -->
    ...
    <div class="row white">
      <div class="col s10 offset-s1">
        <h5 class="center-align">Tunjangan Transportasi </h5>
             <table class="bordered highlight responsive-table">
              <thead>
                <tr>
                    <th>No </th>
                    <th>Kd transportasi</th>
                    <th>Nm Jarak</th>
                    <th>Jarak</th>
                    <th> Tunjangan Jarak</th>
                </tr>
              </thead>
            <tbody>
